...
function cw_load() {
	...
	wp_enqueue_style('cw-app-style',  SR_URL . '/css/style.css', array(), 1.0, 'all');
	wp_enqueue_style('cw-app-drawing',  SR_URL . '/css/drawing.css', array(), 1.0, 'print');
	wp_enqueue_style('cw-app-quotation',  SR_URL . '/css/quotation.css', array(), 1.0, 'print');
	...
	wp_enqueue_script('cable-connectors', SR_URL .'/js/services/cable-connectors.js');
