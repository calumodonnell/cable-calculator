...
function cw_add_cable(){
  ...
  if(isset($_POST['extended_boots'])){ $extended_boots = $_POST['extended_boots']; } else { $extended_boots = ""; }
  ...
  elseif (isset($_POST['cable_img'])) :
    ...
    if (!empty($_POST['connector_part']) && array_filter($_POST['connector_part'])) :
      foreach( $_POST['connector_part'] as $row => $value ) :
        ...
        if(isset($connector)):
      		$pricing_sql = "INSERT INTO cw_cable_connector_pricing (cable_id, connector_id, con_part_no, con_series, con_max_freq, price) VALUES ('" . $_POST['cable_id'] . "', '" . $_POST['connector_part'][$row] . "', '" . $connector[0]['con_part_no'] . "', '" . $connector[0]['con_series'] . "', '" . $_POST['connector_freq'][$row] . "', '" . $_POST['connector_price'][$row] . "')";
      		$pricing_query = $wpdb->query($pricing_sql);
        endif;
    	endforeach;
    endif;
