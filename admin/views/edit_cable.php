...
<div class="wrap">
  ...
  <p>Fields marked with an * are required</p>
	<form name="add_trainer" id="add_trainer" action="<?php echo admin_url('admin.php?page=add-cable&action=edit&edit=yes'); ?>" method="post" onsubmit="return checkForm_edit();" enctype="multipart/form-data">
		<table style="padding-left:5px;" class="create_trainer" cellspacing="5">
			<tr>
				<td width="150">Cable Name</td>
				<td>
					<input class="cw_input" type="hidden" name="cable_id" id="cable_id" value="<?php echo stripslashes($cable[0]['id']); ?>"/>
					<input class="cw_input" type="text" name="name" id="name" value="<?php echo stripslashes($cable[0]['name']); ?>"/>
				</td>
			</tr>
			<tr>
				<td>Part No</td>
				<td><input type="text" class="cw_input" name="part_no" id="part_no" value="<?php echo stripslashes($cable[0]['part_no']);?>"></td>
			</tr>
			<tr>
				<td>Max. Frequency</td>
				<td><input type="text" class="cw_input" name="max_freq" id="max_freq" value="<?php echo stripslashes($cable[0]['max_freq']);?>"> GHz</td>
			</tr>
			<tr>
				<td>Diameter</td>
				<td><input type="text" class="cw_input" name="diameter" id="diameter" value="<?php echo stripslashes($cable[0]['diameter']);?>"> in</td>
			</tr>
			<tr>
				<td>Min. Bend</td>
				<td><input type="text" class="cw_input" name="min_bend" id="min_bend"  value="<?php echo stripslashes($cable[0]['min_bend']);?>"/> in</td>
			</tr>
			<tr>
				<td>Typical Attenuation K1</td>
				<td><input type="text" class="cw_input" name="typ_atten_k1" id="typ_atten_k1"  value="<?php echo stripslashes($cable[0]['typ_atten_k1']);?>"/></td>
			</tr>
			<tr>
				<td>Typical Attenuation K2</td>
				<td><input type="text" class="cw_input" name="typ_atten_k2" id="typ_atten_k2"  value="<?php echo stripslashes($cable[0]['typ_atten_k2']);?>"/></td>
			</tr>
			<tr>
				<td>Outdoor</td>
			...
			<tr>
				<td><h2>Cable Pricing</h2></td>
			</tr>
			<tr>
				<td>Margin Rate</td>
				<td><input type="text" class="cw_input" name="margin_rate" id="margin_rate" value="<?php echo stripslashes($cable[0]['margin_rate']); ?>"/></td>
			</tr>
			<tr>
				<td>Hourly Labor Rate</td>
				<td><input type="text" class="cw_input" name="hour_lab_rate" id="contact_name" value="<?php echo stripslashes($cable[0]['hour_lab_rate']);?>"/></td>
			</tr>
			<tr>
				<td>Overhead Rate</td>
				<td><input type="text" class="cw_input" name="overhead_rate" id="overhead_rate" value="<?php echo stripslashes($cable[0]['overhead_rate']);?>"/></td>
			</tr>
			<tr>
				<td>Ship Handling</td>
				<td><input type="text" class="cw_input" name="ship_handling" id="ship_handling" value="<?php echo stripslashes($cable[0]['ship_handling']);?>"/></td>
			</tr>
			<tr>
				<td>QM1</td>
				<td><input type="text" class="cw_input" name="qm1" id="qm1" value="<?php echo stripslashes($cable[0]['qm1']);?>"/></td>
			</tr>
			<tr>
				<td>QM2</td>
				<td><input type="text" class="cw_input" name="qm2" id="qm2" value="<?php echo stripslashes($cable[0]['qm2']);?>"/></td>
			</tr>
			<tr>
				<td>QM3</td>
				<td><input type="text" class="cw_input" name="qm3" id="qm3" value="<?php echo stripslashes($cable[0]['qm3']);?>"/></td>
			</tr>
			<tr>
				<td>QM4</td>
				<td><input type="text" class="cw_input" name="qm4" id="qm4" value="<?php echo stripslashes($cable[0]['qm4']);?>"/></td>
			</tr>
			<tr>
				<td>QM5</td>
				<td><input type="text" class="cw_input" name="qm5" id="qm5" value="<?php echo stripslashes($cable[0]['qm5']);?>"/></td>
			</tr>
			<tr>
				<td>QM6</td>
				<td><input type="text" class="cw_input" name="qm6" id="qm6" value="<?php echo stripslashes($cable[0]['qm6']);?>"/></td>
			</tr>
			<tr>
				<td>QM7</td>
				<td><input type="text" class="cw_input" name="qm7" id="qm7" value="<?php echo stripslashes($cable[0]['qm7']);?>"/></td>
			</tr>
			<tr>
				<td>QM8</td>
				<td><input type="text" class="cw_input" name="qm8" id="qm8" value="<?php echo stripslashes($cable[0]['qm8']);?>"/></td>
			</tr>
			<tr>
				<td><h2>Cable Coating Pricing</h2></td>
			</tr>
			<tr>
				<td><b>None</b></td>
			</tr>
			...
			<tr>
				<td><b>Armorized/Weatherized Jacket</b></td>
			</tr>
			<tr>
				<td>Cable Base</td>
			...
			<tr>
				<td><b>Armor/Neoprene Jacket</b></td>
			</tr>
			<tr>
				<td>Cable Base</td>
			...
			<tr>
				<td><b>Extended Boots/Weatherized</b></td>
			</tr>
			<tr>
				<td>Cable Base</td>
